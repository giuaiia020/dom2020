...
$direktori = $_SERVER['DOCUMENT_ROOT'].'/'.$niche2.'/';
$urlx = $_SERVER['REQUEST_URI'];
$urlx = preg_replace("/[^a-zA-Z0-9\s]+/", "", $urlx);
$xml = str_replace ('manualbookxml','.txt',$urlx);
$xml = ''.$direktori.''.$xml.'';
$interval = -1; //interval -5 jam ke belakang


$urls=@file($xml,FILE_IGNORE_NEW_LINES|FILE_SKIP_EMPTY_LINES) or die('nothing here');
