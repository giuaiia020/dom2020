<?php
$title = 'manual guide pdf books';
header('Content-type: text/html; charset=UTF-8');
$title    	= 	str_replace(array('/','-','+','-','Printable_2019','.html','pdf','_','.'),' ',$title);
...
<meta content='<?php echo $domainnya;?>' name='Author'/>
...
<meta content='PDF BOOKS LIBRARY' name='description'/>
<meta content='http://<?php echo $domainnya;?>' property='og:url'/>
<meta content='PDF BOOKS LIBRARY' property='og:title'/>
<meta content='PDF BOOKS LIBRARY pdf download.free download pdf,pdf download free,pdf ebook download' property='og:description'/>
<!--[if IE]> <script> (function() { var html5 = ("abbr,article,aside,audio,canvas,datalist,details," + "figure,footer,header,hgroup,mark,menu,meter,nav,output," + "progress,section,time,video").split(','); for (var i = 0; i < html5.length; i++) { document.createElement(html5[i]); } try { document.execCommand('BackgroundImageCache', false, true); } catch(e) {} })(); </script> <![endif]-->
<!-- SEO Meta Tag -->
<meta content='PDF BOOKS LIBRARY, pdf download.free download pdf,pdf download free,pdf ebook download' name='keywords'/>
<meta content='PDF BOOKS LIBRARY pdf download.free download pdf,pdf download free,pdf ebook download' name='description'/>
<!-- SEO Meta Tag end -->
<!-- SEO Title Tag -->
<title>PDF BOOKS LIBRARY</title>
<meta content='blog' property='og:type'/>
<meta content='http://4.bp.blogspot.com/-HMGjCfyK4lY/WT5oLPjTlJI/AAAAAAAACxw/eAwaZwBGbb4WPZb_eFkK107SXrEQs9FdgCK4B/s1600/dumdum.png' property='og:image'/>
<meta content='PDF BOOKS LIBRARY pdf download.free download pdf,pdf download free,pdf ebook download' property='og:description'/>
<meta content='PDF BOOKS LIBRARY' property='og:site_name'/>
<meta content='<?php echo $domainnya;?>' property='article:author'/>
<meta content='<?php echo $domainnya;?>' property='article:publisher'/>
<meta content='en_US' property='og:locale'/>
<meta content='en_GB' property='og:locale:alternate'/>
<meta content='fr_FR' property='og:locale:alternate'/>
<meta content='it_IT' property='og:locale:alternate'/>
<meta content='PDF BOOKS LIBRARY' name='twitter:site'/>
<meta content='summary_large_image' name='twitter:card'/>
<meta content='@<?php echo $domainnya;?>' name='twitter:creator'/>
<link href='http://<?php echo $domainnya;?>/indexer' rel='alternate' title='PDF BOOKS LIBRARY - Atom' type='application/atom+xml'/>
<link href='http://<?php echo $domainnya;?>/feed' rel='alternate' title='PDF BOOKS LIBRARY - RSS' type='application/rss+xml'/>
<link href='http://<?php echo $domainnya;?>/1rss' rel='alternate' title='PDF BOOKS LIBRARY - Atom' type='application/atom+xml'/>
<!--[if IE]> <script> (function() { var html5 = ("abbr,article,aside,audio,canvas,datalist,details," + "figure,footer,header,hgroup,mark,menu,meter,nav,output," + "progress,section,time,video").split(','); for (var i = 0; i < html5.length; i++) { document.createElement(html5[i]); } try { document.execCommand('BackgroundImageCache', false, true); } catch(e) {} })(); </script> <![endif]-->
...
.PopularPosts h2:after{
    ...
    margin:13px 0 0 0;
    width:100%;
    background:url(//4.bp.blogspot.com/-R2WTW6O9E1o/VX7dqIGT1eI/AAAAAAAACc4/pyvQDMMLX3E/s1600/repeat-bg.png);
    opacity:.9
}
#blog-pager{
    text-align:center;
...
<a class="author-meta g-profile" href="/" rel="author" title="Admin">'.$domainnya.'</a></span>
</span>
